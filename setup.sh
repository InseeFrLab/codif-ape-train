...
mc cp minio/projet-ape/CodificationAnalyse.sh.20221108_090040.zip data/

7z x data/CodificationAnalyse.sh.20221108_090040.zip -odata/
rm data/CodificationAnalyse.sh.20221108_090040.zip
mv data/CodificationAnalyse.sh.20221108_090040.log data/api_log.log
