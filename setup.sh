...
mc cp minio/projet-ape/CodificationAnalyse.sh.20221028_155348.zip data/

7z x data/CodificationAnalyse.sh.20221028_155348.zip -odata/
rm data/CodificationAnalyse.sh.20221028_155348.zip
mv data/CodificationAnalyse.sh.20221028_155348.log data/api_log.log
