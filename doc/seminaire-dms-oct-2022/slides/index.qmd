...
- Près de 80% des libellés issus du guichet unique sont correctement codififiés ;
...
plot_F1_distrib_by_cat <- function(data){
  ggplot(data) + 
    ggtitle("Distribution du F1-score en \nfonction de la fréquence des classes")+
...
- Indice de confiance retenu : différence des deux probabilité les plus élevée.
