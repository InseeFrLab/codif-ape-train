...
class Tokenizer:
    ...
    def __init__(
        ...
        Args:
            ...
            buckets (int): Number of buckets (rows in the embedding matrix).
    ...
    def get_nwords(self) -> int:
        """
        Returns number of words kept in training data.
    ...
    def get_buckets(self) -> int:
        """
        Returns number of buckets for tokenizer.
    ...
    def get_ngram_list(word: str, n: int) -> List[str]:
        """
        Returns the list of character n-grams for a word with a
        given n.
    ...
    def get_subword_index(self, subword: str) -> int:
        """
        Returns the row index from the embedding matrix which
    ...
    def get_subwords(self, word: str) -> Tuple[List[str], List[int]]:
        """
        Returns all subword tokens and indices for a given word.
