...
df["LIB_CLEAN"] = df["LIB_CLEAN"].str.replace(r"\b\s+\b", " ", regex=True)
df.dropna(subset=["APE_SICORE", "LIB_CLEAN"], inplace=True)
df["LIB_CLEAN"] = df["LIB_CLEAN"].replace("", np.nan, regex=False)
df.dropna(subset=["APE_SICORE", "LIB_CLEAN"], inplace=True)
